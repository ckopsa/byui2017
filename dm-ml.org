...
*** Building the tree:
    ...
    adoption-of-the-budget-resolution == y
       THEN democrat
    IF physician-fee-freeze == y AND
    IF synfuels-corporation-cutback == n AND
    IF superfund-right-to-sue == y AND
    IF export-administration-act-south-africa == ? AND
    ...
    export-administration-act-south-africa == n
       THEN republican
    IF superfund-right-to-sue == ? AND
    export-administration-act-south-africa == ?
       THEN republican
    IF export-administration-act-south-africa == y AND
    duty-free-exports == y
       THEN democrat
    duty-free-exports == n
       THEN republican
    ...
    superfund-right-to-sue == n
       THEN republican
    IF synfuels-corporation-cutback == y AND
    IF mx-missile == n AND
    IF export-administration-act-south-africa == ? AND
    duty-free-exports == ?
       THEN republican
    ...
    adoption-of-the-budget-resolution == n
       THEN republican
    IF adoption-of-the-budget-resolution == y AND
    duty-free-exports == y
       THEN republican
    duty-free-exports == n
       THEN democrat
    IF export-administration-act-south-africa == n AND
    IF superfund-right-to-sue == y AND
    water-project-cost-sharing == y
       THEN republican
    IF water-project-cost-sharing == n AND
